...
(defn handle-connection-fixture [f]
  (binding [*connection* (create :host "irc.freenode.net" :port 6667 :nick "pgbot")]
    (f)
    (.close (*connection* :socket))))

(use-fixtures :once handle-connection-fixture)
